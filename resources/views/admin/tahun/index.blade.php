                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="action-btn-group">
                                    <form action="{{ route('admin.tahun.updateStatus', $tahun->id) }}" method="POST"
                                    ...
                                    <form action="{{ route('admin.tahun.destroy', $tahun->id) }}" method="POST"
                                        class="d-inline-block" onsubmit="return confirm('Hapus tahun ajaran ini?')">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close-modal"
                    onclick="document.getElementById('addYearModal').classList.remove('show')">
            ...
            <form action="{{ route('admin.tahun.store') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-cancel"
                        onclick="document.getElementById('addYearModal').classList.remove('show')">Batal</button>
