    ...
    <div class="card">
        ...
        <div class="card-body" style="padding: 20px;">
            <form action="{{ route('admin.laporan.index') }}" method="GET">
                <div class="main-grid"
                    style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 20px; align-items: end;">
                        ...
                        <select name="tahun_ajaran" id="tahun_ajaran" class="form-select" style="width: 100%;">
                            ...
                            @foreach ($tahunAjarans as $tahun)
                                <option value="{{ $tahun->nama }}"
                                    {{ request('tahun_ajaran') == $tahun->nama ? 'selected' : '' }}>
                                    {{ $tahun->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <select name="jenjang" id="jenjang" class="form-select" style="width: 100%;">
                            ...
                            <option value="MA" {{ request('jenjang') == 'MI' ? 'selected' : '' }}>MI</option>
                        </select>
                    </div>
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <select name="status" id="status" class="form-select" style="width: 100%;">
                            ...
                            <option value="accept" {{ request('status') == 'accept' ? 'selected' : '' }}>Diterima
                            </option>
                            <option value="incomplete_file" {{ request('status') == 'incomplete_file' ? 'selected' : '' }}>
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ...
                            <a href="{{ route('admin.laporan.print', request()->all()) }}" target="_blank" class="btn-save"
                                style="flex: 1; justify-content: center; background-color: #4b5563; border-color: #4b5563;">
