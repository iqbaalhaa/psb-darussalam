                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; flex-direction: column;">
                                    ...
                                    <span style="font-size: 0.8rem; color: var(--text-light);">{{ $item->user->email ?? '-' }}</span>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="action-btn-group" style="display: flex; gap: 8px; justify-content: flex-end;">
                                    <button class="action-btn view btn-detail" 
                                            data-url="{{ route('admin.pendaftar.show', $item->id) }}"
                                            title="Lihat Detail">
                                    ...
                                    <a href="{{ url('admin/edit-pendaftar/' . $item->id) }}" 
            ...
            $(document).ready(function() {
                ...
                function attachModalActionHandlers() {
                    ...
                    $('#form-update-status').on('submit', function(e) {
                        ...
                        btn.prop('disabled', true).html('<i class="fa-solid fa-circle-notch fa-spin"></i> Menyimpan...');
                        ...
                        $.ajax({
                            ...
                            error: function(xhr) {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Oops...',
                                    text: 'Terjadi kesalahan: ' + (xhr.responseJSON?.message || 'Gagal update status')
                                });
                            },
                            complete: function() {
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    ...
                                    error: function(xhr) {
                                        ...
                                        btn.prop('disabled', false).html('<i class="fa-solid fa-trash"></i> Hapus Permanen');
                                    }
                                });
                            }
                        })
