            ...
            <div class="left-col">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                ...
                                @else
                                    <span style="color: var(--success);"><i class="fa-solid fa-lock-open"></i> Terbuka</span>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">{{ $data->anak_ke }} dari {{ $data->jumlah_saudara }} bersaudara</div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div style="margin-top: 15px; font-size: 0.85rem; color: var(--text-light); text-align: center;">
                        <i class="fa-solid fa-info-circle"></i> No. KK: <strong>{{ $data->no_kk }}</strong> | Kode Pos: <strong>{{ $data->kode_pos }}</strong>
                    </div>
                </div>
            </div>
            ...
            <form id="formUpdateStatus" action="{{ url('admin/update-status-pendaftaran/' . $data->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="status-grid">
                        {{-- Pending --}}
                        <div class="status-card pending {{ $data->status == 'pending' ? 'selected' : '' }}" onclick="selectStatus(this, 'pending')">
                        ...
                        {{-- Incomplete --}}
                        <div class="status-card incomplete {{ $data->status == 'incomplete_file' ? 'selected' : '' }}" onclick="selectStatus(this, 'incomplete_file')">
                            <input type="radio" name="status" value="incomplete_file" {{ $data->status == 'incomplete_file' ? 'checked' : '' }}>
                        ...
                        {{-- Reject --}}
                        <div class="status-card reject {{ $data->status == 'reject' ? 'selected' : '' }}" onclick="selectStatus(this, 'reject')">
                            <input type="radio" name="status" value="reject" {{ $data->status == 'reject' ? 'checked' : '' }}>
                        ...
                        {{-- Accept --}}
                        <div class="status-card accept {{ $data->status == 'accept' ? 'selected' : '' }}" onclick="selectStatus(this, 'accept')">
                            <input type="radio" name="status" value="accept" {{ $data->status == 'accept' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="4" placeholder="Tuliskan alasan perubahan status atau instruksi selanjutnya...">{{ $data->keterangan }}</textarea>
                    </div>
                </div>
