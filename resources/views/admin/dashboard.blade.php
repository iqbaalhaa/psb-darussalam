    ...
    <div class="dash-grid">
        ...
        <div class="card span-12 span-lg-8">
            ...
            <div class="mini-actions">
                ...
                <button class="btn" type="button" onclick="alert('Nanti: halaman Verifikasi Pending')">Verifikasi
                    Pending</button>
            </div>
        ...
        <div class="card span-12 span-lg-4">
            ...
            <p class="muted" style="margin:0 0 10px;">
                Dashboard ini sudah siap dipakai untuk data real. Tinggal sambungkan ke tabel registrations / documents /
                statuses.
            </p>
