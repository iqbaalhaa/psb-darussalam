            ...
            <div class="container hero__inner">
                <div class="hero__content">
                    <div class="badge">
                        ...
                        Penerimaan Santri Baru • <strong>TA {{ $tahunAktif->nama ?? 'TBA' }}</strong> • Gelombang <strong>1</strong> dibuka
                    </div>

                    <h1>
                        Penerimaan Santri Baru <span class="accent">MA</span> — TA <span class="accent">{{ $tahunAktif->nama ?? 'TBA' }}</span>
                    </h1>
